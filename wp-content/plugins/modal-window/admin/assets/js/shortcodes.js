...
(function ($) {
    ...
    $("#shortcode_type").on("change", function () {
        shortCodeType();
        buildShortcode();
    });
    ...
    function shortCodeType() {
        ...
        $('.button-box, .video-box, .icon-box, .shortcode-preview, .iframe-box').addClass('is-hidden');
        if (shortcode === 'button') {
        ...
        } else if (shortcode === 'iframe') {
            $('.iframe-box').removeClass('is-hidden');
        }
    }
    ...
    function buildShortcode() {
        ...
        if (type === 'video') {
            ...
            let iframe_link = $('#iframe_link').val();
            let iframe_width = $('#iframe_width').val();
            let iframe_height = $('#iframe_height').val();
            const iframe_id = $('#iframe_id').val();
            const iframe_class = $('#iframe_class').val();
            const iframe_style = $('#iframe_style').val();

            shortcode = '[iframeBox link="'+iframe_link+'" width="'+iframe_width+'" height="'+iframe_height+'" id="'+iframe_id+'" class="'+iframe_class+'" style="'+iframe_style+'"]';
        }
